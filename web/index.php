...
class Index {
    ...
    public function loadClass($name) {
        $classes = array(
            ...
            'ThreadDao' => '../dao/ThreadDao.php',
            'UserDao' => '../dao/UserDao.php',
            'Post' => '../model/Post.php',
            'Thread' => '../model/Thread.php',
            'User' => '../model/User.php',
            'Mapper' => '../mapping/Mapper.php',
            'UserRegistrationValidator' => '../validation/UserRegistrationValidator.php',
...
//        }
    ...
    function getScript($page) {
        $page = self::PAGE_DIRECTORY . $page . '-script'. self::EXTENSION;
        return $page;
    }
